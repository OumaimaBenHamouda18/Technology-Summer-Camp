...
<head>
    ...
    <title>Afegir Participantes</title>
...
<body>
    ...
    <div class="row d-flex justify-content-center">
        ...
        <form method="POST" action="Afegirparticipant.php">
...
<div class="forms-inputs mb-4">
    ...
    <input class="btn button btn-dark " type="submit" value="Agregar participante" name="afegir">
...
if(isset($_POST["afegir"])){
    ...
    if($fila[0]) echo"<span class='warning'>Participant ya inscrito</span>";
    else {
        ...
        if(mysqli_fetch_row(mysqli_query($enlace,$sentenciaComprobacionFK))[0]){
            $sentencia="INSERT INTO PARTICIPANTES values('$dni','$nombre','$apellidos','$direccion','$telefono','$correo','$fecha_nacimiento','$tarjeta_sanitaria','$codi_Ins')";
            $result=mysqli_query($enlace,$sentencia);
            if($result) echo "<span class='exito'>Participante Inscrito con exito</span>";
        }
