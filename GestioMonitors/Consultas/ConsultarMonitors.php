...
<head>
    ...
    <title>Consultar PMonitors</title>
...
<body>
    <div class="container mt-5">
        <div class="row d-flex justify-content-center">
            <div class="col-md-7">
                <div class="card px-5" >
                    <h2>Consultar Monitors</h2>
                    <form method="POST" action="ConsultarMonitors.php">
                        <input class="button" type="submit" name="consultar" value="Consultar Monitores"> 
                    </form>                
                </div>
            </div>
        </div>
...
if(isset($_POST["consultar"])){
    ...
    //sentencia select
        ...
        $sentenciaSelect="SELECT * from supervisores";
