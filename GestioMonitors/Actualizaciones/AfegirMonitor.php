...
<div class="forms-inputs mb-4">
    ...
    <input class="btn button btn-dark " type="submit" value="Agregar Monitor" name="afegir">
...
if(isset($_POST["afegir"])){
    ...
    if($fila[0]) echo"<span class='warning'>Monitor ya asignado</span>";
    else {

        $sentencia="INSERT INTO supervisores values('$dni','$nombre','$apellidos','$direccion','$telefono','$correo','$fecha_nacimiento','$tarjeta_sanitaria','$role')";
        $result=mysqli_query($enlace,$sentencia);
        if($result) echo "<span class='exito'>Monitor asignado con exito<span>";
    }
