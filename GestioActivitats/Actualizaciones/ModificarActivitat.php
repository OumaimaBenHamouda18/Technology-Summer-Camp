...
<html>
<head>
        <!--Nom fitxer: ModificarActivitat.php
        Autora: Sujil Shrestha
        Data creació: 07/02/2024 -->
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>ModificarActivitat</title>
...
<?php
            ...
            if ($fila[0]==1) {
                ...
                SET DISCRIPCION='$DISCRIPCION', NOMBRE='$NOMBRE', COSTOADDICIONAL='$COSTOADDICIONAL', DURACION='$DURACION', ESTADO='$ESTADO', MATERIAL='$MATERIAL', CODIGO_U='$CODIGO_U' WHERE CODIGO='$CODIGO'";
