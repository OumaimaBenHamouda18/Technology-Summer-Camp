...
<html>
<head>
        <!--Nom fitxer: AssignarHabitacioMonitor.php
        Autora: Sujil Shrestha
        Data creació: 02/02/2024 -->
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title> AssignarHabitacioMonitor </title>
...
<div class="container mt-5">
        <div class="row d-flex justify-content-center">
            <div class="col-md-7">
                <div class="card px-5" >
                <h2>Assignar Habitación Monitor</h2>

                <form method="POST" action="AssignarHabitacioMonitor.php">
                    <div class="forms-inputs mb-4">
                        <label for="CODIGO_U">CODIGO_U: </label>
                        <input type="text" name="CODIGO_U" id="CODIGO_U" size=20 required> 
                    </div>
                    <div class="forms-inputs mb-4">
                        <label for="CODIGO_S">CODIGO_S: </label>
                        <input type="text" name="CODIGO_S" id="CODIGO_S" size=20 required> 
                    </div>
                    <div class="forms-inputs mb-4">
...
<?php
            ...
            $sentencia= "SELECT count(*) FROM ALOJARSUPERVISORES Where CODIGO_U= '$CODIGO_U' and CODIGO_S ='$CODIGO_S'";
            ...
            if ($fila[0]) {
                echo "<span class='error'>Monitor ya alojado</span>";
            }
            else {
                ...
                $sentenciaComprobacionFK2="SELECT COUNT(*) FROM supervisores WHERE dni='$CODIGO_S'";
                ...
                if(mysqli_fetch_row(mysqli_query($enlace,$sentenciaComprobacionFK1))[0]){
                    ...
                    if(mysqli_fetch_row(mysqli_query($enlace,$sentenciaComprobacionFK2))[0]){
                        ...
                        $sentencia ="INSERT INTO ALOJARSUPERVISORES values
                        ('$CODIGO_U', '$CODIGO_S', '$FECHA_ENTRADA', '$FECHA_SALIDA', '$SALA_HABITACION')";
                        echo "<br>";
                    ...
                    else echo "<span class='warning'>El campo codigo_S debe tener un valor de la tabla Supervisores</span>";
